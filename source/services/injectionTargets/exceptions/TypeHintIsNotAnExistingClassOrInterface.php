...
class TypeHintIsNotAnExistingClassOrInterface extends InvalidInjectionTargetParameter
{
	/**
	...
	{
		$message = 'The class or interface of the type hint does not exist. Each parameter of an injection target must have an existing class or interface as type hint.';
