...
use tueena\core\services\injectionTargets\InjectionTargetInvokeMethod;
use tueena\spec\core\stubs\B;
use tueena\spec\core\stubs\C;
use tueena\spec\core\stubs\D;

class InjectionTargetInvokeMethodTest extends \PHPUnit_Framework_TestCase
{
	/**
	 * @test
	 */
	...
	{
		// given
		$Target = new InjectionTargetInvokeMethod(new D);
	...
	public function The_invoke_method_calls_the_injection_target_with_the_given_parameters_and_returns_the_result()
	{
		...
		$C = new C;
		$D = new D;
		$Target = new InjectionTargetInvokeMethod($D);
	 ...
	 * @test
	 */
	public function getInjectionTargetTypeName_returns_the_string_invoke_method()
	{
		// given
		$Target = new InjectionTargetInvokeMethod(new D);
		...
		// then
		$this->assertEquals('invoke method', $injectionTargetTypeName);
	}
}
